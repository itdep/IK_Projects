						...
						<tr<?php if($index%2){echo " class='alternate'";}?>>
							...
							<td colspan="2" valign="middle">
								...
								<div class="row-actions">
									...
									<span class="trash">
										<a href="?page=<?php echo self::$plugin_menu_slug ?>&action=delete&item=<?php echo $snippet->id ?>&actioncode=<?php echo wp_create_nonce($snippet->id."delete") ?>&<?php echo self::$plugin_post?>" onclick="return confirm('\tWait!\nIf you delete this item, you won\'t get it back!\nDo you wish to continue?')">Delete</a>
									</span>
								</div>
							</td>
